...
local Window = OrionLib:MakeWindow({Name = "CookieScript - Pies", HidePremium = false,IntroText = "CookieScript - Pies",IntroEnabled = true, SaveConfig = true, ConfigFolder = "OrionTest"})
...
local Credits2 = Credits:AddSection({
	Name = "1. Jay stole ur script lol "
})

local Credits2 = Credits:AddSection({
	Name = "2. Jay stole ur script lol "
})

local Credits2 = Credits:AddSection({
	Name = "3. Jay stole ur script lol "
})
