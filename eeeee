...
local Window = OrionLib:MakeWindow({Name = "GitBook Booga", HidePremium = false,IntroText = "CookieScript - Pies",IntroEnabled = true, SaveConfig = true, ConfigFolder = "OrionTest"})
